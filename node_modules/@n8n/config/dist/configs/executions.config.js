...
let ExecutionsConfig = class ExecutionsConfig {
    constructor() {
        ...
        this.scheduledExecutionDeduplicationEnabled = false;
    }
};
...
__decorate([
    (0, decorators_1.Env)('N8N_SCHEDULED_EXECUTION_DEDUPLICATION_ENABLED'),
    __metadata("design:type", Boolean)
], ExecutionsConfig.prototype, "scheduledExecutionDeduplicationEnabled", void 0);
