...
function updateNodeAst({ nodePath, className, baseUrl, project, }) {
    const sourceFile = (0, ast_1.loadSingleSourceFile)(nodePath, project);
...
function updateCredentialAst({ repoName, baseUrl, credentialPath, credentialName, credentialDisplayName, credentialClassName, project, }) {
    const sourceFile = (0, ast_1.loadSingleSourceFile)(credentialPath, project);
    const classDecl = sourceFile.getClasses()[0];
...
function addCredentialToNode({ nodePath, credentialName, project, }) {
    const sourceFile = (0, ast_1.loadSingleSourceFile)(nodePath, project);
    const classDecl = sourceFile.getClasses()[0];
