...
exports.LmChatNvidiaNim = void 0;
const openai_1 = require("@langchain/openai");
const n8n_workflow_1 = require("n8n-workflow");
class LmChatNvidiaNim {
    constructor() {
        this.description = {
            ...
            properties: [
                {
                    displayName: 'Use this node as the Chat Model input of AI Agent or AI Chain nodes',
                ...
                {
                    displayName: 'If using JSON response format, include the word "json" in your chain or agent prompt',
                    name: 'jsonNotice',
                    type: 'notice',
                    default: '',
                    displayOptions: {
